...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	private static boolean drawAnArrow = false;
	private static int clickedMouse = 0;
	...
	private static JMenuBar createMenuBar() {
		...
		JMenu algo = new JMenu("Algorithem");
		menuBar.add(menu);
		menuBar.add(algo);
		...
		JMenuItem menuAlgo1 = new JMenuItem(" Is Connected...   ");
		menuAlgo1.addActionListener(std);
		algo.add(menuAlgo1);
		
		JMenuItem menuAlgo2 = new JMenuItem(" shortest path distance...   ");
		menuAlgo2.addActionListener(std);
		algo.add(menuAlgo2);
		
		JMenuItem menuAlgo3 = new JMenuItem(" shortest path ...   ");
		menuAlgo3.addActionListener(std);
		algo.add(menuAlgo3);
		
		JMenuItem menuAlgo4 = new JMenuItem(" TSP ...   ");
		menuAlgo4.addActionListener(std);
		algo.add(menuAlgo4);
	...
	public static void drawArrowLine(double x1, double y1, double x2, double y2) {
	    double dx = x2 - x1, dy = y2 - y1;
	    double D = Math.sqrt(dx*dx + dy*dy);
	    double xm = D - 0.00008, xn = xm, ym = 0.00008, yn = -0.00008, x;
